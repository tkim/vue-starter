...
const clientConfig = nodeRequire('../../packages/webpack/dist/config/client').default;
const isomorphicConfig = nodeRequire('../../packages/webpack/dist/config/isomorphic').default;
